...
class ExportToBridge(QgsProcessingAlgorithm, Planning):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        trans = QgsCoordinateTransform(source.sourceCrs(), QgsCoordinateReferenceSystem('EPSG:4326'),
    ...
    def export_sam_route(self, table, output):
        ...
        with open(output, 'w', newline='', encoding='ansi') as csvfile:
            ...
            # write header as list of fields
            header = ['Name', 'Latitude [°]', 'Longitude [°]', 'Turn Radius [NM]', 'Max. Speed [kn]', 'XTD [m]',
                      'Sailmode', 'Additional Notes']
            csv_writer.writerow(header)
